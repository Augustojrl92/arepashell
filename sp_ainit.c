...
void splitter_errors_init(t_automata *a)
{
   ...
   // printf(">> [Errors] Error 5: %s\n", a->errors[5]);
    ...
    a->errors[10] = NULL;
    a->errorlen = 9;
    //printf(">> [Init] Errores inicializados correctamente.\n");
}
